      ...
      <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
        ...
        >
          <AnimatedWords2
            title={"Let's Connect"}
            style={
              "flex max-w-[400px] flex-col items-start text-left text-[150px] font-bold uppercase leading-[0.9em] text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center sm:text-[25px] md:text-[70px] lg:text-center lg:text-[100px] xl:text-[150px]"
            }
          />
